# Codex App Automations Communication Policy

Codex App Automations must follow the repository-wide Korean user-facing communication policy while preserving English technical artifacts where appropriate.
